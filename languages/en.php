<?php
    ...
    $index_slider_title_4_msg="TechKids Aged 5-8";
    ...
    $index_slider_title_5_msg="TechKids Aged 9-12";
    ...
    $index_slider_title_6_msg="Who’s the Team?";    
    ...
    // curriculumn section 
    $index_cur_title_msg="Curriculum";
    $index_cur_title_1_msg=" Coding";
    $index_cur_content_1_msg=" By including coding as a core subject in our school we teach kids 21st century skills such as application and games development.";
    $index_cur_title_2_msg="Designing";
    $index_cur_content_2_msg="Our designing track includes teaching children graphic designing, illustration and video and sound editing in an engaging and fun a way.";
    $index_cur_title_3_msg="Making";
    $index_cur_content_3_msg="By including real-world activities into classroom we inspire kids to launch products,
                                such as making electronic devices and small robots.";
    $index_cur_title_4_msg=" Animation";
    $index_cur_content_4_msg="TechKids provide young children with tools and applications that allow them to create their own animation film. Following topics are covered in our animation sessions.";
    //technology section 

    $index_tech_title_msg="Teaching Methodology";
    $index_tech_content_msg="Our approach to teaching your kids includes Play And Learn. Utilizing state-of-the-art technologies, we empower kids to succeed. Our methodology is unique, we include in our curriculum more than the traditional 3 Rs (reading, writing, and arithmetic). Our focus is to bring collaborative, hands-on, real-world problem-solving activities into the classroom. Kids enrolled at our classes work together with their teachers and other children to learn and share experiences in a fun way.
    ...
    //footer section 
    $index_footer_1="About TechKids";
    $index_footer_content_msg="TechKids is a technology education lab for children teaching Coding, Design and Making. We offer full time and part time pre-school, primary school classes, and after school workshops for children aged 3-12.";
    $index_footer_2_title="Countact US";
    $index_footer_3_title="TechKids, TechNation Compound";
    $index_footer_4_title="Next to Amarkhel Clinic";
    $index_footer_5_title="Next to Amarkhel Clinic";
    $index_footer_6_title="Deh Naw-e-Dehboori";
    $index_footer_7_title="Kabul, Afghanistan";
    $index_footer_8_title="Phone: (+93) (0) 788 161 862";
    $index_footer_9_email="Email";
    //  header section with menu bar 
    $index_header_1_msg="Home";
    $index_header_2_msg="About Us";
    $index_header_3_msg="Curriculum ";
    $index_header_4_msg="Methodology";
    $index_header_5_msg="Gallery";
    $index_header_6_msg="Contact Us";
    $index_header_main_title="TechKids";

    // curriculumn page 
    $index_curcolumn_1_title="Curriculum";
    $index_curcolumn_1_content="
...
TechKids team researches and evaluates recent developments in educational technology and source innovative hands-on play tools to help children enrolled with us can learn effectively. TechKids’ curriculum educates and inspires child. Topics covered in TechKids coding, designing and making tracks. Some examples of our classes and workshops held during classroom incursions include followings:";
    $index_curcolumn_2_title="Prototyping:";
    $index_curcolumn_2_content=" TechKids provides children with an open source library of electronic modules that snap together with magnets for prototyping, learning and fun.";
    $index_curcolumn_3_title="Robots:";
    $index_curcolumn_3_content="    
    ...
    $index_curcolumn_4_title="Making:";
    $index_curcolumn_4_content="
        We provide kids with invention kits that turn everyday objects, such as water bottles, into touch pads.";
    $index_curcolumn_5_title="Animation:";
    $index_curcolumn_5_content="    
    ...
    $index_about_1_title="Who We Are";
    $index_about_1_content="TechKids is a technology education lab for children teaching Coding, Design and Making. We offer full time and part time pre-school, primary school classes, and after school workshops for children aged 3-12.";
    $index_about_2_content="TechKids inspires and empowers kids through educational technology, tools and methodologies. We stimulate mind, develop leadership, and critical thinking of your children. Our goal is to help your kids realize their potential and become exceptional individuals. We provide them with state-of-the-art tools and applications so they can learn through play and do extraordinary things. Children enrolled in our programs can do more than an ordinary kid can.";
    $index_about_3_content="We teach technology through hands-on practical experience in three major tracks: 1) Coding, 2) Designing, and 3) Making. Our Coding track includes teaching kids how to code, develop applications, computer games; the Designing track includes graphics designing in variety of design applications; and the Making track includes making electronic devices and small robots.
                               ";
    $index_about_4_content="In addition to these key TechKids tracks, we teach traditional school subjects such as mathematics, languages geography, history, painting, and religion  all through utilize technology to help your children learn effectively. We also include public speaking, TV/ Radio anchoring, fine arts and other support activities in our curriculum. This helps you kids express themselves, become speakers, debaters and writers.
                               ";
    $index_about_2_title="Why Choose Us";
    $index_about_3_title="TechKids is teaching 21st century skills";
    $index_about_5_content="TechKids is researching evaluating technologies that can help children learn fast in a fun way. We integrate both software and hardware tools that are used by world's top educational institutions.";
    $index_about_4_title="TechKids is equipped with latest technologies";
    $index_about_6_content="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown pri.";
    $index_about_7_title="TechKids builds leaders and thinkers";
    $index_about_7_content="We expose kids to many new concepts at an early age. On top of the TechKids core subjects and traditional schools subjects TechKids adds the 4 Cs: Collaboration, Creativity, Communication, and Critical Thinking. This helps young children become exceptional individuals by doing extraordinary things in life.";
    $index_about_8_title="Team";
    $index_about_9_title="Board of Directors";
    $index_about_1_job="President TechNation";
    $index_about_name="Omar Mansoor";
    $index_about_lastname="Ansari";
    $index_about_2_job="Assistant Prof (Web Technologies), Kabul University";
    $index_about_2_name="Baseer Ahmad";
    $index_about_2_lastname="Baheer";
    $index_about_3_name="Karima";
    $index_about_3_lastname=" Quraishi";
    //  ansari page 
    $index_ansari_title="Omar Mansoor Ansari";
    $index_ansari_1_title="President TechNation";
    $index_ansari_1_content="His most recent work includes founding Open Source Alliance of Central Asia (OSACA), Open Source Afghanistan, TechWomen Afghanistan, TechWomen Central Asia, TechDeira, and TechWorks, all platforms for technology promotion and development, and education and networking. Omar is President of TechNation and is Chairing the National ICT Alliance of Afghanistan (NICTAA), the country's largest consortium of ICT players.";
    $index_ansari_2_content="Omar is Afghanistan's senior entrepreneur and researcher in ICT. He has more than a decade experience in building institutions, coalition and start-ups. Omar worked with Microsoft and IDRC on software localization and received Microsoft Localization Champion Award. He worked as the Co-founder/ Executive director of Afghan Computer Science Association (ACSA), 1999-2008, and Founder/ Editor-in-Chief of the Computer Science bimonthly.";
   


    // Baseer Ahamad  page  
    $index_baseer_title="Baseer Ahmad Baheer";
    $index_baseer_1_title="Assistant Prof (Web Technologies), Kabul University";
    $index_baseer_2_title="Baseer is Afghanistan's top-notched web engineer with years of experience in teaching, developing technologies and creating tools and applications for desktop, web and mobile. Baseer received his BSc. in Computer Science from the University of Kabul, Afghanistan in 2005, and earned an MSc. in Software Engineering from the Technische Universitat Berlin, Berlin, Germany in 2010.";

    //karima page 
    $index_karima_title="Karima Quraishi ";


    // contact page 
    $index_contact_title="Contact us";
    $contanct_msg_placeholder = "Type your message here...";
    $index_contact_name_placeholder="Name";
    $index_contact_email_placeholder="Email";
    $index_contact_send_btn="Send";

    // form page 

    $index_form_title="Login page";
    $index_form_1_title="Login OR Register Here!";
    $index_form_2_title="Login With  Your Own Account";
    $index_form_3_title="Please Login! ";
    ...
    $index_form_6_message="Forget your Password?";
    $index_form_7_message="Register";
    $index_form_8_message="as a ";
    $index_form_9_message="Teacher";
    $index_form_10_message="Student";
    $index_form_11_message="Parent";
    $form_email="Email";
    ...
    $index_methodology_title="Methodology";
    $index_methodology_1_title="        Our approach to teaching your kids includes Play And Learn. Utilizing state-of-the-art technologies, we empower kids to succeed. Our methodology is unique, we include in our curriculum more than the traditional 3 Rs (reading, writing, and arithmetic). Our focus is to bring collaborative, hands-on, real-world problem-solving activities into the classroom. Kids enrolled at our classes work together with their teachers and other children to learn and share experiences in a fun way.
    ...
    $index_login_msg=" Successfully Registerd!";
    $index_login_msg_1="registeration Faild!";
    $index_login_msg_2="Your account has not been activated yet!";

    //chang.php page 

    $index_chang_h2="WHO ARE YOU!!";
    $index_chang_msg="you are Not a member of this site please";
    $index_chang_0_msg="Register";
    $index_chang_1_msg="This link has been Expired";
    $index_chang_2_msg="Change your password";
    $index_chang_3_msg="Please enter your new password to change it";
    $index_chang_placeholder="Enter new password";
    $index_chang_0_placeholder="Confirm your password";
    $index_chang_btn="Submit";
    $index_chang_0_h2="WHO ARE YOU!!";
    $index_chang_4_msg="you are no a member of this site please";
    $index_chang_5_msg="Expired!!";
    $index_chang_6_msg="This link has been Expired";
    $index_chang_1_h2="Success!!";
    $index_chang_7_msg="You have successfully changed your password. Please";
    $index_chang_password_match="Your password match";
    $index_chang_password_not_match="Your password dose not match";

   //email.php page 

    $index_email_msg="Yes I want to change my password!!";
    $index_email_0_msg="dear sir";
    $index_email_1_msg="You can change your TechKids account password by clickin the bellow link:";
    $index_email_2_msg="An email hass been sent to";
    $index_email_3_msg="please check your email and confirm it.";
    $index_email_4_msg="Failed to sent email Please try again";
    $index_email_5_msg="Failed to change your password please try again later.";
    $index_email_6_msg="We have sent an email to ";
    $index_email_7_msg="please check your email .";
    $index_email_8_msg="there is no account with this email please";
    $index_email_9_msg="there i;s no account with this email please";
    $index_email_9_msg="Your self.";

    // forget.php page 
    $index_forget_h2="Forget your password?";
    $index_forget_msg="Please Enter your email for changeing your password";
    $index_forget_btn="Email Address";
    $index_forget_0_btn="Submit";


    //  Register.php page 
    $index_register_h3="Registeration";
    ...
    $index_register_not_match_p="Password does not match";
